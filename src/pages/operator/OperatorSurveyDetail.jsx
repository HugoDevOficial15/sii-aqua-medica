...
export default function OperatorSurveyDetail({
    ...
    const calculateScore = () => {
        ...
        preguntas.forEach(pregunta => {
            ...
            // Si el administrador no definió la respuesta correcta, la pregunta no se puede
            // calificar y no debe contar como error.
        ...
        if (calificables > 0) {
            ...
            // Solo 100 si SOLO hay preguntas abiertas
            calificacion = 100;
        }
