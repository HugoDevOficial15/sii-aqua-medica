export const AREAS = [
    ...
    { id: "comite", nombre: "Comité Técnico" },
    { id: "contabilidad", nombre: "Contabilidad" },
    { id: "direccion", nombre: "Dirección General" },
    { id: "mantenimiento", nombre: "Mantenimiento" },
    { id: "operaciones", nombre: "Gerencia de Operaciones" },
    { id: "sostenible", nombre: "Gestión Sostenible" },
    { id: "produccion", nombre: "Producción" },
    { id: "recepcion", nombre: "Recepcion" },
    { id: "rh", nombre: "Recursos Humanos" },
    { id: "sanitario", nombre: "Responsable Sanitario" },
    { id: "salud", nombre: "Salud Ocupacional" },
    { id: "seguridad", nombre: "Seguridad" },
    { id: "servicios", nombre: "Servicios" },
    { id: "serviciomedico", nombre: "Servicio Médico" },
